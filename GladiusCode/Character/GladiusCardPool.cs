...
public class GladiusCardPool : CustomCardPoolModel
{
    ...
    public override float H => .17f; //Hue; changes the color.
    ...
    public override Color DeckEntryCardColor => new("bf9b30");
