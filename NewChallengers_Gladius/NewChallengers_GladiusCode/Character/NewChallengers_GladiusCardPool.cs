...
public class NewChallengers_GladiusCardPool : CustomCardPoolModel
{
    public override string Title => NewChallengers_Gladius.CharacterId; //This is not a display name.
